            ...
            <div class="row justify-content-center">
                            ...
                            <div class="container">
                                <div class="row justify-content-between">
                                    <div class="col-sm-6 nav-left justify-content-start d-flex">
                                        <div class="thumb">
                                            <img src="{{ asset('blogger/img/prev.jpg') }}" alt="">
                                        </div>
                                        <div class="details">
                                            <p>Prev Post</p>
                                    ...
                                    <div class="col-sm-6 nav-right justify-content-end d-flex">
                                        ...
                                        <div class="thumb">
                                            <img src="{{ asset('blogger/img/next.jpg') }}" alt="">
                                        </div>                         
                                    </div>
                                </div>
                            </div>    
                                ...
                                <div class="row flex-column">
                                    ...
                                    <div class="comment-list">
                                        <div class="single-comment justify-content-between d-flex">
                                            <div class="user justify-content-between d-flex">
                                                <div class="thumb">
                                                    <img src="{{ asset('blogger/img/asset/c1.jpg') }}" alt="">
                                                </div>
                                                <div class="desc">
                                    ...
                                    <div class="comment-list left-padding">
                                        <div class="single-comment justify-content-between d-flex">
                                            <div class="user justify-content-between d-flex">
                                                <div class="thumb">
                                                    <img src="{{ asset('blogger/img/asset/c2') }}.jpg" alt="">
                                                </div>
                                                <div class="desc">
                                                    <h5><a href="#">Emilly Blunt</a></h5>
                                                    <p class="date">December 4, 2017 at 3:12 pm </p>
                                    ...
                                    <div class="comment-list left-padding">
                                        <div class="single-comment justify-content-between d-flex">
                                            <div class="user justify-content-between d-flex">
                                                <div class="thumb">
                                                    <img src="{{ asset('blogger/img/asset/c3.jpg') }}" alt="">
                                                </div>
                                                <div class="desc">
                                                    <h5><a href="#">Emilly Blunt</a></h5>
                                                    <p class="date">December 4, 2017 at 3:12 pm </p>
                                    ...
                                    <div class="comment-list">
                                        <div class="single-comment justify-content-between d-flex">
                                            <div class="user justify-content-between d-flex">
                                                <div class="thumb">
                                                    <img src="{{ asset('blogger/img/asset/c4.jpg') }}" alt="">
                                                </div>
                                                <div class="desc">
                                                    <h5><a href="#">Emilly Blunt</a></h5>
                                                    <p class="date">December 4, 2017 at 3:12 pm </p>
                                    ...
                                    <div class="comment-list">
                                        <div class="single-comment justify-content-between d-flex">
                                            <div class="user justify-content-between d-flex">
                                                <div class="thumb">
                                                    <img src="{{ asset('blogger/img/asset/c5.jpg') }}" alt="">
                                                </div>
                                                <div class="desc">
                                                    <h5><a href="#">Emilly Blunt</a></h5>
                                                    <p class="date">December 4, 2017 at 3:12 pm </p>
                ...
                <div class="col-lg-4 sidebar-area ">
                    ...
                    <div class="single_widget about_widget">
                        <img src="{{ asset('blogger/img/asset/s-img') }}.jpg" alt="">
                    ...
                    <div class="single_widget recent_widget">
                        ...
                        <div class="active-recent-carusel">
                            <div class="item">
                                <img src="{{ asset('blogger/img/asset/slider.jpg') }}" alt="">
